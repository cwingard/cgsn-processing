#!/bin/bash
#
# Read the parsed PRESF data files from the CGSN Coastal Surface Moorings and
...
IN="$DATA/parsed/$PLATFORM/$DEPLOY/$PRESF/$FILE"
OUT="$DATA/processed/$PLATFORM/$DEPLOY/$PRESF/${FILE%.json}.nc"
