...
# source may have been flort, replace for output with turbd
OUTFILE=${FILE%.json}
OUTFILE=${OUTFILE/flort/turbd}
OUTINSTLOC=${INSTLOC}
OUTINSTLOC=${OUTINSTLOC/flort/turbd}
echo "outfile: $OUTFILE, outpath: $OUTINSTLOC"
