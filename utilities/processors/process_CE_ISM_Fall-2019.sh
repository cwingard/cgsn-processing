...
case "$PLATFORM" in
    "ce01issm"  )
        ...
        LAT=44.659
        LON=-124.095
        declare -a FLORT1=("1121")
        declare -a FLORT2=("1302")
        declare -a PCO2W1=("C0061")
        declare -a PCO2W2=("C0063")
        ;;
    "ce06issm" )
        MFN_DEPTH=29
        LAT=47.133
        LON=-124.272
        declare -a FLORT1=("1151")
        declare -a FLORT2=("996")
        declare -a PCO2W1=("C0062")
        declare -a PCO2W2=("C0053")
        ;;
    * )
...
$PROCESS/process_ctdbp.sh $PLATFORM $DEPLOY $LAT $LON "buoy/ctdbp" 1 ${FLORT1[0]} "flort" $FNAME.ctdbp3.json
