...
def main():
    ...
    # add the raw channels, the downwelling irradiance and the wavelengths with the additional dimension of the
    ...
    d = nc.createVariable('raw_channels', 'i', ('time', 'wavelengths',))
    d.setncatts(spkir_attr['raw_channels'])
    d[:] = channels

    d = nc.createVariable('irradiance', 'f', ('time', 'wavelengths',))
