...
PCO2A = {
    ...
    'pCO2': {'units': 'ppm'},
    'avg_irga_temperature': {'units': 'degree_Celsius'},
    'humidity': {'units': 'mbar'},
    'humidity_temperature': {'units': 'degree_Celsius'},
    'gas_stream_pressure': {'units': '1'},
    'irga_detector_temperature': {'units': 'degree_Celsius'},
    'irga_source_temperature': {'units': 'degree_Celsius'},
    'z_water': {
