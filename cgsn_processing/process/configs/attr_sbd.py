...
common = {
    ...
    'estimated_latitude': {
        ...
        'units': 'degrees_north',
        'comment': ('This field provides the geographic location of the SBD modem. The latitude and longitude provide '
                    'a center point and the cep_radius provides the radius of a circle around that center point. The '
                    'reported position is accurate (within the reported circle) 80 percent of the time.')
    },
    'estimated_longitude': {
...
xeos = {
    'global': {
        ...
        'summary': ('Xeos Technologies GPS beacons used to determine the location of the mooring during a '
                    'deployment. Beacons attached to the tower have a watch circle (radius varies based on site '
                    'depth) enabled to alert if they go adrift. Beacons attached to subsurface elements will only '
                    'report their location when they are on the surface. Normally, that only occurs when the mooring'
                    'is being deployed or recovered.')
    },
    'watch_circle_status': {
        ...
        'comment': ('The watch circle status indicates the watch circle mode: disabled, enabled, or alarm. The watch '
                    ...
                    'the site depth) defined in meters. When the watch circle is enabled, the beacon will send an '
                    'alarm message if it moves outside the watch circle.')
    },
    'subsurface_beacon': {
        ...
        'comment': ('The subsurface beacon flag indicates whether the beacon is attached to a subsurface element '
                    '(e.g., a subsurface mooring float) or to the tower.')
    },
    'precise_latitude': {
        'long_name': 'Precise Latitude',
        'standard_name': 'latitude',
        'units': 'degrees_north',
        'comment': ('Indicates the precise latitude of the beacon using data from the GPS antenna at the time of the '
                    'Iridium SBD transmission.')
    },
    'precise_longitude': {
        'long_name': 'Precise Longitude',
        'standard_name': 'longitude',
        'units': 'degrees_east',
        'comment': ('Indicates the precise longitude of the beacon using data from the GPS antenna at the time of the '
                    'Iridium SBD transmission.')
    },
